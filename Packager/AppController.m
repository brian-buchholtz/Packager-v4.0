...
- (void)OpenProject {
    ...
    if (stringProjectFile) {
        ...
        NSString *ApplicationName = dictProject[@"ApplicationName"];
        NSString *ApplicationVersion = dictProject[@"ApplicationVersion"];
        
        // Project metadata
        NSString *ProjectName = dictProject[@"ProjectName"];
        NSString *ProjectVersion = dictProject[@"ProjectVersion"];
        NSString *ProjectHome = dictProject[@"ProjectHome"];
        NSString *ProjectOwner = dictProject[@"ProjectOwner"];
...
- (void)SaveProject {
    ...
    if (stringProjectFile) {
        ...
        // Write project file
        [Project writeProject:stringProjectFile ApplicationName:stringApplicationName ApplicationVersion:stringAppVersion ProjectName:stringProjectName ProjectVersion:stringProjectVersion ProjectHome:stringProjectHome ProjectOwner:stringProjectOwner ProjectGroup:stringProjectGroup ProjectPermissions:stringProjectPermissions];
